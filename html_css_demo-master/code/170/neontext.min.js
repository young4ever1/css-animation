  ...
  (this.resetTime = 10),
      ...
      return (
        o.forEach(function (o, s) {
          ...
          (a.style.display = "inline-block"),
            ...
            (a.style.zIndex = e.hasAttribute("ele-range") ? "1" : "-1"),
            (a.style.color = t.randomColor()),
            (a.own = {
              pos: { x: 0, y: 0 },
              ran: { x: -0.5 + Math.random(), y: -0.5 + Math.random() },
              speed: { x: 1, y: 1 },
              dir: { x: 1, y: 1 },
            }),
            e.appendChild(a),
    ...
    (this.resetpos = function () {
      this.spanOrigin(),
        console.log(
          e +
            "====" +
            this.spanArr[0].own.pos.x +
            "====" +
            this.posRangen.maxRange.x
        ),
        this.spanArr.forEach(function (n, e) {
          n.own.realPos.minx + n.own.pos.x < t.posRangen.minRange.x &&
            (n.own.pos.x = 0),
            n.own.realPos.maxx + n.own.pos.x > t.posRangen.maxRange.x &&
              (n.own.pos.x = 0),
            n.own.realPos.miny + n.own.pos.y < t.posRangen.minRange.y &&
              (n.own.pos.y = 0),
            n.own.realPos.maxy + n.own.pos.y > t.posRangen.maxRange.y &&
              (n.own.pos.y = 0);
        });
    }),
    (this.floatText = function () {
      this.spanArr.forEach(function (n, e) {
        (n.own.realPos.minx + n.own.pos.x < t.posRangen.minRange.x ||
          n.own.realPos.maxx + n.own.pos.x > t.posRangen.maxRange.x) &&
          (n.own.dir.x = -n.own.dir.x),
          (n.own.realPos.miny + n.own.pos.y < t.posRangen.minRange.y ||
            n.own.realPos.maxy + n.own.pos.y > t.posRangen.maxRange.y) &&
            (n.own.dir.y = -n.own.dir.y),
          (n.own.pos.x += n.own.ran.x * n.own.speed.x * n.own.dir.x),
          (n.own.pos.y += n.own.ran.y * n.own.speed.y * n.own.dir.y),
          (n.style.transform =
            "translateX(" +
            n.own.pos.x +
            "px) translateY(" +
    ...
    (this.floatBack = function () {
      if (
        ...
        return cancelAnimationFrame(t.send), !0;
      this.resetTime += 5;
    }),
